        ...
        <div className="w-full h-full bg-slate-950 text-white overflow-y-auto scrollbar-hide pb-24">
            <div className="max-w-[1400px] mx-auto p-6 space-y-6">
                ...
                <div className="flex flex-col lg:grid lg:grid-cols-12 gap-6">
                    ...
                    {/* Calendar */}
                    <div className="order-1 lg:col-span-4 lg:order-3 bg-slate-900 border border-white/10 rounded-[30px] p-6 text-white shadow-xl h-fit">
                    ...
                    {/* History List */}
                    <div className="order-2 lg:col-span-4 lg:order-5 bg-slate-900 border border-white/10 rounded-[30px] p-3 shadow-xl h-fit max-h-[500px] flex flex-col">
                    ...
                    {/* Radar Chart */}
                    <div className="order-4 lg:col-span-5 lg:order-2 bg-slate-900 border border-white/10 rounded-[30px] p-6 flex items-center justify-center shadow-2xl relative overflow-hidden min-h-[350px]">
